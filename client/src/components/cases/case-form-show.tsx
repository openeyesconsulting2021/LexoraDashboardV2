...
export default function CaseDtailsForm({
  case: editCase,
  onClose,
  onSuccess,
}: CaseFormProps) {
  ...
  const caseFormDetailsSchema = insertCaseSchema.extend({
  ...
  const form = useForm({
    resolver: zodResolver(caseFormDetailsSchema),
    defaultValues: {
  ...
  const createMutation = useMutation({
    mutationFn: async (data: z.infer<typeof caseFormDetailsSchema>) => {
  ...
  const onSubmit = (data: z.infer<typeof caseFormDetailsSchema>) => {
    if (editCase) {
